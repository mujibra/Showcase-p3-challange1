    ...
    <div>
      <div className="flex justify-center">
        <div className="flex-shrink-0 bg-white p-5">
          ...
          <button className="shadow-sm w-full text-white rounded-md hover:bg-blue-500 flex items-center px-5 py-2 transition-colors duration-150 justify-center bg-blue-600">
