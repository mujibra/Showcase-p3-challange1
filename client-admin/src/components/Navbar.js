      ...
      <div class="flex justify-center">
        <div class="flex-shrink-0 bg-white p-5">
          ...
          <div class="p-2 w-full mt-2.5">
            <span class="text-gray-600">Main menu</span>
          </div>
          <div class="p-2 w-full">
            <a class="flex  text-gray-600 hover:text-blue-600 p-1" href="#home">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <a
              class="flex  mt-2.5 text-gray-600 hover:text-blue-600 p-2"
              href="#profile"
            >
              <svg
                width="24"
              ...
              <span class="ml-2.5">Categories</span>
            </a>
            <a
              class="flex  mt-2.5 text-gray-600 hover:text-blue-600 p-1"
              href="#projects"
            >
              <svg
                width="24"
              ...
              <span class="ml-2.5">Register Admin</span>
            </a>
          </div>
          <button class="shadow-sm w-full text-white rounded-md hover:bg-blue-500 flex items-center px-5 py-2 transition-colors duration-150 justify-center bg-blue-600">
